...
const BookInfo = ({ selectedBook, onFormSubmit }) => {
  ...
  return (
    <div className='border-2 border-[#0CA1E2] h-[900px] w-[35%] flex flex-col gap-1 bg-white shadow-3xl rounded-md'>
    <div className='bg-[#0CA1E2] pt-5 pl-4 h-[55px] font-montserrat text-white  text-[15px]'>
    ...
    <form className='pl-[10px] flex flex-col gap-2 mt-2' onSubmit={handleSubmit}>
      ...
      <div className='flex flex-col w-[400px]'>
        <label className='font-montserrat text-[17px] font-semibold'>Status</label>
      ...
      {/* Tags */}
      <div className='flex flex-col w-[400px]'>
        <label className='font-montserrat text-[17px] font-semibold'>Tags</label>
        <input 
      ...
      <div className="flex gap-2 self-end mr-10 mt-3">
        <button className="bg-[#0CA1E2] hover:bg-blue-500 text-[white] py-2 w-[75px] rounded-lg cursor-pointer font-montserrat text-[14px]" type="submit">Submit</button>
        <button className="bg-gray-500 hover:bg-gray-600 text-[white] py-2 w-[75px] rounded-lg cursor-pointer font-montserrat text-[14px]" type="submit" onClick={handleClear}>Clear</button>
      </div>
    </form>
