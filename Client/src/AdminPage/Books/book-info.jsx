  ...
  return (
        <div className='border-2 border-[#C2FFB8] h-[80%] w-[40%] flex flex-col gap-2 bg-white'> 
            <div className='bg-[#C2FFB8] pt-5 pl-4 h-[55px]'>
                <h1>{selectedBook ? 'Edit Book Information' : 'Add Book Information'}</h1>
            </div>
              ...
              <div className="flex self-end mr-10 mt-5">
                ...
                {success ? (
                    <div className="text-green-600">
                        <p>Book {selectedBook ? 'updated' : 'added'} successfully!</p>
                    </div>
                ) : (
                    <div className="text-red-600">{errors.message && <p>{errors.message}</p>}</div>
                )}
            </form>
        </div>
  )
